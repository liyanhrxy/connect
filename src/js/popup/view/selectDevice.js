...
export const selectDevice = (payload: $PropertyType<SelectDevice, 'payload'>): void => {
    ...
    payload.devices.forEach(device => {
        ...
        if (device.type !== 'acquired' || device.status === 'occupied') {
            ...
            const htmlUnreadable: string = 'Please install <a href="https://desktop.onekey.so/bridge/" target="_blank" rel="noreferrer noopener" onclick="window.closeWindow();">Bridge</a> to use OneKey device.';
