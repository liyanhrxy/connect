...
const Enum_ExportType = Object.freeze({
    SeedEncExportType_NO: 0,
    SeedEncExportType_YES: 1,
    MnemonicPlainExportType_YES: 2,
});
export type ExportType = $Values<typeof Enum_ExportType>;
...
const Enum_SeedRequestType = Object.freeze({
    SeedRequestType_Gen: 0,
    SeedRequestType_EncExport: 1,
    SeedRequestType_EncImport: 2,
});
export type SeedRequestType = $Values<typeof Enum_SeedRequestType>;
...
const Enum_WL_OperationType = Object.freeze({
    WL_OperationType_Add: 0,
    WL_OperationType_Delete: 1,
    WL_OperationType_Inquire: 2,
});
export type WL_OperationType = $Values<typeof Enum_WL_OperationType>;
...
export type MessageType = {
    ...
    BixinSeedOperate: $Exact<BixinSeedOperate>;
    BixinMessageSE: $Exact<BixinMessageSE>;
    BixinOutMessageSE: BixinOutMessageSE;
    BixinReboot: BixinReboot;
    BixinBackupRequest: BixinBackupRequest;
    BixinBackupAck: $Exact<BixinBackupAck>;
    BixinRestoreRequest: $Exact<BixinRestoreRequest>;
    BixinRestoreAck: $Exact<BixinRestoreAck>;
    BixinVerifyDeviceRequest: $Exact<BixinVerifyDeviceRequest>;
    BixinVerifyDeviceAck: $Exact<BixinVerifyDeviceAck>;
    BixinWhiteListRequest: $Exact<BixinWhiteListRequest>;
